...
public class TreasureGameLevel2 {
    ...
    public static void main(String[] args) {
        getInput();
        int minnerStep = minDistance('M'), dragonStep = minDistance('D');
        if(dragonStep > minnerStep){
            System.out.println("Miner wins by taking the shortest route of " + minnerStep + " steps");
        }else{
